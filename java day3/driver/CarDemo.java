...
public class CarDemo {
    public static void main(String[] args) {
        ...
        Car nexon = new Car("Nexon","Petrol",1500,1.5,6,mrf,sony);
        Car audi = new Car("Audi","Petrol",1500,2.5,7,apollo,jbl);
        Car rr = new Car("Rolls Royce","Diesel",1500,2.5,6,mrf,jbl);
